...
- Minimum hardware for the OVA lab (per the cert datasheets): **i5-class 4-CPU machine,
  32 GB RAM, ~40 GB free disk** — see [WCP-P](../pam-bastion/wcp-p-professional.md#lab-environment).
...
formats described in the [certification framework](../overview/certification-framework.md#labs):
...
- The **OT** course (`eWCP-P-OT`) uses **demos rather than a full VM lab** — no separate
  lab hardware list is specified (see [eWCP-P-OT](../ot-pam4ot/ewcp-p-ot-professional.md#prerequisites)).
...
- **WCA-P** — 4 VMs (DC + Windows Server + Linux + **1 Bastion**); Azure for
  instructor-led, OVA for e-learning. See [WCA-P lab environment](../pam-bastion/wca-p-administrator.md#lab-environment).
- **WCP-P** — **6 VMs** (DC + Windows Server + Linux + **2 Bastion** + **1 Access
  Manager**). See [WCP-P lab environment](../pam-bastion/wcp-p-professional.md#lab-environment).
- **WCE-P** — **5 VMs** (DC + Windows Server + Linux + **2 Bastion**; no separate Access
  Manager VM). See [WCE-P lab environment](../pam-bastion/wce-p-expert.md#lab-environment).
...
- Repo grounding: [certification framework](../overview/certification-framework.md), [WCA-P](../pam-bastion/wca-p-administrator.md), [WCP-P](../pam-bastion/wcp-p-professional.md), [WCE-P](../pam-bastion/wce-p-expert.md), [bastion-architecture](../deep-dives/bastion-architecture.md)
