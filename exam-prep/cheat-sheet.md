...
[product-portfolio.md](../docs/00-overview/product-portfolio.md#password--secrets-management).)
...
(Sources: [product-portfolio.md](../docs/00-overview/product-portfolio.md#product-certifications--standards),
...
- [Certification framework](../docs/00-overview/certification-framework.md) · [Product portfolio](../docs/00-overview/product-portfolio.md)
...
- [docs/00-overview/certification-framework.md](../docs/00-overview/certification-framework.md) (final MCQ, 70% pass, levels/prereqs)
- [docs/00-overview/product-portfolio.md](../docs/00-overview/product-portfolio.md) (object model, certifications, encryption)
