...
- **Target the WALLIX Certified Administrator – PAM (`WCA-P`):** "understand the solution
  ...
  See [../docs/pam-bastion/wca-p-administrator.md](../docs/pam-bastion/wca-p-administrator.md).
- **Then the WALLIX Certified Professional – PAM (`WCP-P`):** install, configure, deploy,
  and administer in a standard architecture. See
  [../docs/pam-bastion/wcp-p-professional.md](../docs/pam-bastion/wcp-p-professional.md).
...
- **WALLIX Certified Expert – PAM (`WCE-P`):** advanced, large-scale, complex
  ...
  knowledge.** See [../docs/pam-bastion/wce-p-expert.md](../docs/pam-bastion/wce-p-expert.md).
...
- This repo — certification framework: [../docs/00-overview/certification-framework.md](../docs/00-overview/certification-framework.md)
