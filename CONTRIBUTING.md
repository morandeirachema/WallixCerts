...
1. Put it in the right section folder (`foundations/`, `prerequisites/`, `docs/`,
   `deep-dives/`, `labs/`, `exam-prep/`, `career/`, `reference/`).
2. Add a row for it in that folder's `README.md` index.
3. If it's a new certification, follow the structure of
   `docs/pam-bastion/wcp-p-professional.md` and add it to the matrix in the root `README.md`.
...
- [ ] **WALLIX product doc versions** referenced in `deep-dives/` (Bastion 12.3.2, Access
...
- [ ] **Adjacent certifications** flagged as time-sensitive in `career/`: Microsoft
