...
interactive login) covered in the [product portfolio ACL model](../overview/product-portfolio.md#core-pam-concepts--the-acl-data-model).
...
Access Manager: X.509, SAML). See [wce-p-expert.md](../pam-bastion/wce-p-expert.md).
...
flowchart TD
    ...
    subgraph Priority["PRIORITY = HA FALLBACK among<br/>authenticators of SAME factor"]
        direction LR
...
Cross-references: [product portfolio](../overview/product-portfolio.md) ·
[WCE-P expert curriculum](../pam-bastion/wce-p-expert.md) ·
