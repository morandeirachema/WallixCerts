...
[certification framework](../overview/certification-framework.md#common-exam--assessment-model)):
...
This is stated per-cert in [WCA-P](../pam-bastion/wca-p-administrator.md#assessment),
[WCP-P](../pam-bastion/wcp-p-professional.md#assessment), and
[WCE-P](../pam-bastion/wce-p-expert.md#assessment).
...
| 4 | [product-portfolio — Bastion section](../overview/product-portfolio.md#1-wallix-bastion--privileged-access-management-pam) | 1.5 h |
| 5 | [WCA-P datasheet](../pam-bastion/wca-p-administrator.md) — match each module to a topic | 0.5 h |
...
| 4 | [WCP-P datasheet](../pam-bastion/wcp-p-professional.md) — note every `Lab x.x` | 0.5 h |
...
| 2 | [WCE-P datasheet](../pam-bastion/wce-p-expert.md) — map modules 1–6 to deep-dives | 0.5 h |
...
| 3 | [product-portfolio — Trustelem section](../overview/product-portfolio.md#3-wallix-trustelem--idaas-sso--mfa--identity-federation) | 1.5 h |
| 4 | [eWCP-I datasheet](../idaas/ewcp-i-professional.md) — modules + Labs 1–6 | 0.5 h |
...
| 2 | [product-portfolio — IAG section](../overview/product-portfolio.md#5-wallix-iag--identity--access-governance) | 1.5 h |
| 3 | [eWCP-G datasheet](../iag/ewcp-g-professional.md) — the project-lifecycle modules + labs | 0.5 h |
...
[WCA-G](../iag/wca-g-administrator.md).)*
...
| 2 | [product-portfolio — PAM4OT section](../overview/product-portfolio.md#6-wallix-pam4ot--operational-technology-ot-security) | 1.5 h |
| 3 | [eWCP-P-OT datasheet](../ot-pam4ot/ewcp-p-ot-professional.md) — OT universe, third-party access, architectures | 0.5 h |
...
- Repo grounding: [certification framework](../overview/certification-framework.md), cert datasheets under [docs/pam-bastion](../pam-bastion/), [docs/idaas](../idaas/ewcp-i-professional.md), [docs/iag](../iag/ewcp-g-professional.md), [docs/ot-pam4ot](../ot-pam4ot/ewcp-p-ot-professional.md); deep-dives in [../deep-dives/](../deep-dives/); labs in [../labs/](../labs/)
