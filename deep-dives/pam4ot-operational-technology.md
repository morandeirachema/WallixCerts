...
> This page supports the [eWCP-P-OT certification](../docs/ot-pam4ot/ewcp-p-ot-professional.md)
...
> is why the [eWCP-P-OT cert](../docs/ot-pam4ot/ewcp-p-ot-professional.md) requires
...
The [eWCP-P-OT curriculum](../docs/ot-pam4ot/ewcp-p-ot-professional.md) lists three
...
- **Cloud / SaaS** — via **WALLIX Remote Access** and the **WALLIX One** SaaS platform
  ...
  passwords**). See the [product portfolio — WALLIX One](../docs/00-overview/product-portfolio.md#2-wallix-one--the-cybersecurity-saas-platform).
...
> [eWCP-P-OT — WALLIX Certified Professional – OT](../docs/ot-pam4ot/ewcp-p-ot-professional.md).
...
- [../docs/00-overview/product-portfolio.md](../docs/00-overview/product-portfolio.md#6-wallix-pam4ot--operational-technology-ot-security)
- [../docs/ot-pam4ot/ewcp-p-ot-professional.md](../docs/ot-pam4ot/ewcp-p-ot-professional.md)
