...
password-rotation plugins); see [wce-p-expert.md](../docs/pam-bastion/wce-p-expert.md).
...
[product portfolio – services](../docs/00-overview/product-portfolio.md#architecture-deployment-ha-integrations)
· [HA & DR](./high-availability-and-dr.md) · [REST API & automation](./rest-api-and-automation.md)
· [authentication & WAM](./authentication-and-access-manager.md) · [WCE-P curriculum](../docs/pam-bastion/wce-p-expert.md)
