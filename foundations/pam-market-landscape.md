...
For the WALLIX product details referenced throughout, see [../docs/00-overview/product-portfolio.md](../docs/00-overview/product-portfolio.md). For how a sysadmin builds toward a PAM role, see [../career/sysadmin-to-pam-roadmap.md](../career/sysadmin-to-pam-roadmap.md).
...
See [../docs/00-overview/product-portfolio.md](../docs/00-overview/product-portfolio.md) for the full technical detail and certification caveats behind each of these.
...
Next: [../career/sysadmin-to-pam-roadmap.md](../career/sysadmin-to-pam-roadmap.md).
